...
const I18N = {
  kz: {
    ...
    "hero.title2": "дәм",
    "hero.sub": "Кухня на углях — Ақтаудағы топ фаст-фуд. Донер, шаурма, пицца және чикен көмір үстінде дайындалады.",
    ...
    "why.2.t": "Балғын дәм",
    "why.2.d": "Ет көмір үстінде піседі, көкөністер әрдайым балғын.",
  ...
  ru: {
    ...
    "hero.title1": "Готовим",
    "hero.title2": "на углях",
    "hero.sub": "Кухня на углях — топовый фаст-фуд Актау. Донер, шаурма, пицца и чикен с настоящим жаром.",
    "hero.cta": "Заказать",
    ...
    "why.2.t": "Свежий вкус",
    "why.2.d": "Мясо готовится на углях, овощи всегда свежие.",
